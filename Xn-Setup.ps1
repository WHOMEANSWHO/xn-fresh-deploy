...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid Margin="20">
    ...
    <Grid Grid.Row="2" x:Name="SetupScreen" Visibility="Collapsed">
      ...
      <Border Grid.Row="0" Background="#10192B" BorderBrush="#263654" BorderThickness="1" CornerRadius="12" Padding="18">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
          <Grid Grid.Row="0">
            <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
            <StackPanel>
              <TextBlock Text="GUIDED PC SETUP" Style="{StaticResource Eyebrow}"/>
              <TextBlock Text="Set up this PC" FontSize="23" FontWeight="SemiBold" Margin="0,3,0,0"/>
              <TextBlock Text="Choose the applications, drivers, gaming tools, and restore actions you want. Nothing starts until you review the summary and press Start PC setup."
                         Style="{StaticResource Hint}" MaxWidth="720" HorizontalAlignment="Left"/>
            </StackPanel>
            <Border Grid.Column="1" Background="#103229" BorderBrush="#167A5B" BorderThickness="1" CornerRadius="9" Padding="12,8" VerticalAlignment="Top">
              <StackPanel Orientation="Horizontal">
                <Ellipse Width="8" Height="8" Fill="#54D6A3" Margin="0,0,8,0"/>
                <TextBlock x:Name="TxtSetupReadiness" Text="SYSTEM READY" Foreground="#54D6A3" FontSize="11" FontWeight="SemiBold"/>
              </StackPanel>
            </Border>
          </Grid>
          ...
          <Grid Grid.Row="1" Margin="0,14,0,0">
            ...
            <Border Grid.Column="0" Background="#171F33" BorderBrush="#2D3A55" BorderThickness="1" CornerRadius="8" Padding="12,9">
              <StackPanel><TextBlock Text="CPU" Style="{StaticResource Eyebrow}"/><TextBlock x:Name="TxtCpuSummary" Text="Detecting..." FontSize="12.5" FontWeight="SemiBold" TextTrimming="CharacterEllipsis" Margin="0,3,0,0"/></StackPanel>
            </Border>
            <Border Grid.Column="2" Background="#171F33" BorderBrush="#2D3A55" BorderThickness="1" CornerRadius="8" Padding="12,9">
              <StackPanel><TextBlock Text="GPU" Style="{StaticResource Eyebrow}"/><TextBlock x:Name="TxtGpuSummary" Text="Detecting..." FontSize="12.5" FontWeight="SemiBold" TextTrimming="CharacterEllipsis" Margin="0,3,0,0"/></StackPanel>
            </Border>
            <Border Grid.Column="4" Background="#171F33" BorderBrush="#2D3A55" BorderThickness="1" CornerRadius="8" Padding="12,9">
              <StackPanel><TextBlock Text="WINDOWS" Style="{StaticResource Eyebrow}"/><TextBlock x:Name="TxtOsSummary" Text="Detecting..." FontSize="12.5" FontWeight="SemiBold" TextTrimming="CharacterEllipsis" Margin="0,3,0,0"/></StackPanel>
            </Border>
          </Grid>

          <Grid Grid.Row="2" Margin="0,13,0,0">
            <StackPanel Orientation="Horizontal">
              <Button x:Name="BtnRecommended" Content="Recommended setup" Style="{StaticResource PrimarySm}"/>
              <Button x:Name="BtnClearSetup" Content="Clear selection" Style="{StaticResource Ghost}" Margin="8,0,0,0"/>
            </StackPanel>
            <TextBlock x:Name="TxtSetupTaskCount" Text="0 tasks selected" Foreground="#4ED0FF" FontSize="13" FontWeight="SemiBold" HorizontalAlignment="Right" VerticalAlignment="Center"/>
          </Grid>
        </Grid>
      </Border>
      ...
      <Grid Grid.Row="1" Margin="0,14,0,0">
          ...
          <StackPanel>
            <Border Style="{StaticResource Card}" Margin="0,0,0,12">
              <StackPanel>
                <DockPanel LastChildFill="True">
                  <StackPanel DockPanel.Dock="Right" Orientation="Horizontal">
                    <Button x:Name="BtnAll" Content="Select apps" Style="{StaticResource Ghost}" Margin="0,0,6,0"/>
                    <Button x:Name="BtnNone" Content="Clear apps" Style="{StaticResource Ghost}"/>
                  </StackPanel>
                  <StackPanel>
                    <TextBlock Text="Essential and optional apps" Style="{StaticResource SectionTitle}"/>
                    <TextBlock Text="Apps install through winget; anything already installed is skipped." Style="{StaticResource Hint}"/>
                  </StackPanel>
                </DockPanel>
                <Border Background="#101728" BorderBrush="#25314A" BorderThickness="1" CornerRadius="9" Padding="12" Margin="0,12,0,0">
            ...
            <Border Style="{StaticResource Card}" Margin="0,0,0,12">
              <Grid>
                ...
                <StackPanel Margin="0,0,14,0">
                  <TextBlock Text="Graphics and hardware drivers" Style="{StaticResource SectionTitle}"/>
                  <TextBlock Style="{StaticResource Hint}" Text="Run trusted driver packages from the local Drivers folder and choose detected hardware helpers."/>
                  ...
                  <Border Background="#101728" BorderBrush="#25314A" BorderThickness="1" CornerRadius="9"
                          Padding="12" Margin="0,12,0,0">
                    <StackPanel>
                      <TextBlock Text="DETECTED HARDWARE" Style="{StaticResource Eyebrow}"/>
                      ...
                      <TextBlock Style="{StaticResource Hint}" Margin="0,8,0,0" Text="For an exact version, place its installer in the Drivers folder. Packages run one at a time."/>
                    </StackPanel>
                  </Border>
                </StackPanel>
            ...
            <Border Style="{StaticResource Card}" Margin="0,0,0,12">
              <StackPanel>
                <TextBlock Text="FiveM and graphics" Style="{StaticResource SectionTitle}"/>
                <TextBlock Text="Install the FiveM client and prepare its managed ReShade base." Style="{StaticResource Hint}"/>
                <Grid Margin="0,13,0,0">
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Margin="0,0,14,0"><TextBlock Text="FiveM" FontSize="13.5" FontWeight="SemiBold"/><TextBlock Text="Download FiveM and open its installer when setup finishes." Style="{StaticResource Hint}"/></StackPanel>
                  <CheckBox x:Name="SwFiveM" Grid.Column="1" Style="{StaticResource Switch}" IsChecked="True" VerticalAlignment="Center"/>
                </Grid>
                <Border Height="1" Background="#263149" Margin="0,12"/>
                <Grid>
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Margin="0,0,14,0"><TextBlock Text="ReShade for FiveM" FontSize="13.5" FontWeight="SemiBold"/><TextBlock Text="Install or restore ReShade after FiveM has been opened once." Style="{StaticResource Hint}"/></StackPanel>
                  <CheckBox x:Name="SwReshade" Grid.Column="1" Style="{StaticResource Switch}" IsChecked="True" VerticalAlignment="Center"/>
                </Grid>
              </StackPanel>
            </Border>
            ...
            <Border Style="{StaticResource Card}" Margin="0,0,0,12">
              <StackPanel>
                <TextBlock Text="Windows and finishing" Style="{StaticResource SectionTitle}"/>
                <Grid Margin="0,12,0,0">
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Margin="0,0,14,0"><TextBlock Text="Fix mouse feel" FontSize="13.5" FontWeight="SemiBold"/><TextBlock Text="Disable Enhance Pointer Precision for consistent aiming." Style="{StaticResource Hint}"/></StackPanel>
                  <CheckBox x:Name="SwMouse" Grid.Column="1" Style="{StaticResource Switch}" IsChecked="False" VerticalAlignment="Center"/>
                </Grid>
                <Border Height="1" Background="#263149" Margin="0,12"/>
                <Grid>
                  <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="Auto"/></Grid.ColumnDefinitions>
                  <StackPanel Margin="0,0,14,0"><TextBlock Text="Open apps when finished" FontSize="13.5" FontWeight="SemiBold"/><TextBlock Text="Open selected apps so they are ready for sign-in." Style="{StaticResource Hint}"/></StackPanel>
                  <CheckBox x:Name="SwLaunch" Grid.Column="1" Style="{StaticResource Switch}" IsChecked="False" VerticalAlignment="Center"/>
                </Grid>
              </StackPanel>
            </Border>
            ...
            <Border Style="{StaticResource Card}">
              <Grid>
                ...
                <StackPanel Margin="0,0,14,0">
                  ...
                  <TextBlock Style="{StaticResource Hint}"
                             Text="Back up browser bookmarks and FiveM settings before a wipe, or restore an available backup during setup."/>
                  ...
                  <TextBlock Style="{StaticResource Hint}" Margin="0,10,0,0" Text="Passwords remain protected by Windows. Use browser sync or Export passwords separately."/>
                </StackPanel>
        ...
        <Border Grid.Column="2" Background="#111A2C" BorderBrush="#2A3855" BorderThickness="1" CornerRadius="12" Padding="17">
          <DockPanel LastChildFill="True">
            <StackPanel DockPanel.Dock="Bottom" Margin="0,14,0,0">
              <Button x:Name="BtnRun" Content="Start PC setup" Style="{StaticResource Primary}" HorizontalAlignment="Stretch"/>
              <TextBlock Text="Windows asks for administrator permission only after you press Start." Style="{StaticResource Hint}" TextAlignment="Center" Margin="0,7,0,0"/>
              <Button x:Name="BtnConfig" Content="Edit app list" Style="{StaticResource Ghost}" HorizontalAlignment="Stretch" Margin="0,9,0,0"/>
            </StackPanel>
            <StackPanel>
              <DockPanel LastChildFill="True">
                <Border DockPanel.Dock="Right" Background="#332A55" CornerRadius="5" Padding="7,3"><TextBlock Text="REVIEW" Foreground="#D2BBFF" FontSize="10" FontWeight="SemiBold"/></Border>
                <TextBlock Text="Deployment summary" FontSize="16" FontWeight="SemiBold"/>
              </DockPanel>
              <TextBlock Text="Selected actions" Style="{StaticResource Eyebrow}" Margin="0,17,0,6"/>
              <TextBlock x:Name="TxtSetupSummary" Text="Nothing selected yet." Foreground="{StaticResource InkBrush}" FontSize="12" TextWrapping="Wrap" LineHeight="24"/>
              <Border Height="1" Background="#2A3855" Margin="0,15"/>
              <TextBlock Text="PRIVILEGES" Style="{StaticResource Eyebrow}"/>
              <TextBlock x:Name="TxtSetupAdmin" Text="Administrator rights are requested only for the setup run." Style="{StaticResource Hint}" Margin="0,6,0,0"/>
              <Border Background="#101728" BorderBrush="#25314A" BorderThickness="1" CornerRadius="8" Padding="11" Margin="0,16,0,0">
                <TextBlock Text="Review every selected action. Driver installers may still ask for input and a restart may be required." Foreground="#FFC14D" FontSize="11.5" TextWrapping="Wrap"/>
              </Border>
            </StackPanel>
          </DockPanel>
        </Border>
      ...
      <Border Grid.Row="2" Background="#101728" BorderBrush="#25314A" BorderThickness="1" CornerRadius="8" Padding="11,7" Margin="0,12,0,0">
        <TextBlock x:Name="FooterHint" Text="Choose only the changes you want. You can safely run setup again later; completed items are skipped where possible."
                   Foreground="{StaticResource MutedBrush}" FontSize="11.5" TextWrapping="Wrap"/>
      </Border>
    </Grid>
...
foreach ($name in 'NavPlay','NavSetup','PlayScreen','ServersPanel','NoServersText','NoServersTitle','NoServersHint','TxtProfileSummary','TxtLibrarySummary',
                  ...
                  'SetupScreen','ProgressScreen','TxtSetupReadiness','TxtSetupTaskCount','TxtCpuSummary','TxtGpuSummary','TxtOsSummary','TxtSetupSummary','TxtSetupAdmin',
                  'AppsPanel','BtnAll','BtnNone','BtnRecommended','BtnClearSetup','SwDrivers','TxtDriversPath',
