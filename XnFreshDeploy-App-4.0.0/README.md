...
- Open **Pack library** to drag and drop or import a soundpack/ReShade folder or ZIP.
...
- **Apply and Play** stages and verifies pack files, enforces FiveM Canary (Latest/Unstable), applies the chosen setup, and connects.
